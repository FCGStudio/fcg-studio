  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-16">
        ...
        <h3 className="text-5xl md:text-7xl font-black uppercase tracking-tighter">Precision in Production</h3>
      </div>
      ...
      <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-12 text-center border-t border-zinc-900 pt-16">
        <div>
          <div className="text-4xl font-black text-yellow-400 italic mb-2">150+</div>
          <div className="text-xs uppercase font-bold tracking-widest text-zinc-500">Music Videos</div>
        </div>
        <div>
          <div className="text-4xl font-black text-yellow-400 italic mb-2">12M+</div>
