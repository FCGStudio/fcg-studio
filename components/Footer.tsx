      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-16 items-start">
        <div className="space-y-6">
          ...
          <div className="flex gap-4 text-2xl">
            ...
            <a 
              href="https://www.instagram.com/fcg_studio_la/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-zinc-600 hover:text-yellow-400 transition-colors"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-xl font-black italic uppercase tracking-tighter">fcgstudiola@gmail.com</p>
            <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs">Los Angeles, CA</p>
          </div>
          <div className="pt-6">
            <a 
              href="mailto:fcgstudiola@gmail.com"
              className="inline-block px-8 py-3 bg-yellow-400 text-black font-black uppercase italic tracking-tighter rounded-sm hover:scale-105 transition-transform text-center"
            >
              Book a session
            </a>
          </div>
